...
def model_opts(parser):
    ...
    group.add('--load_lm', '-load_lm', action="store_true")
    group.add('--bertfix', '-bert_fix', action="store_true")
    group.add('--bert_unfix', '-bert_unfix', action="store_true")
    group.add('--bert_path', '-bert_path', type=str, default=None)
    group.add('--two_model', '-two_model', action="store_true")
    group.add('--partial_load_path', '-partial_load_path', type=str, default=None)
    group.add('--reset_decoder', '-reset_decoder', action="store_true")
    group.add('--architect', '-architect', type=str, default='t5')
...
def train_opts(parser):
    ...
    group.add('--cut_path', '-cut_path', type=str, default=None)
...
def translate_opts(parser):
    ...
    group.add('--share_vocab', '-share_vocab', action='store_true',
              help="Share source and target vocabulary")
    group.add('--save_pred_path', '-save_pred_path', type=str, default=None)
